...
|---|---|---|---|
| Khởi tạo ban đầu | Không áp dụng | Khớp cấu trúc openapi | Đại diện team-iot & team-vision |

## Xác nhận

- Provider representative: team-vision representative (Ngọc Bảo)
- Consumer representative: team-iot representative (Ngọc Bảo)
